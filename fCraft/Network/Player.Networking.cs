...
namespace fCraft
{
    ...
    public sealed partial class Player
    {
        ...
        Player([NotNull] TcpClient tcpClient)
        {
            ...
            {
                Logger.LogAndReportCrash("Session failed to start", "MyCraft", ex, false);
                Disconnect();
            }
        }
        ...
        void IoLoop()
        {
            ...
            catch (Exception ex)
            {
                ...
                Logger.LogAndReportCrash("Error in Player.IoLoop", "MyCraft", ex, false);
#endif
            }
            finally
            {
        ...
        bool ProcessMessagePacket()
        {
            ...
            {
                Logger.LogAndReportCrash("Error while parsing player's message", "MyCraft", ex, false);
        ...
        bool LoginSequence()
        {
            ...
            if (Info.IsBanned)
            {
                ...
                Logger.Log(LogType.SuspiciousActivity,
                            ...
                            Name, IP);
                if (ConfigKey.BannedPlayerMsg.Enabled())
                {
        ...
        void GentlyKickBetaClients()
        {
            ...
            if (strLen >= 2 && strLen <= 16)
            {
                ...
                Logger.Log(LogType.Warning,
                            ...
                            "MyCraft does not support Minecraft Beta.",
                            smpPlayerName, IP);
