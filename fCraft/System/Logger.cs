...
namespace fCraft
{
    ...
    public static class Logger
    {
        ...
        static readonly Uri CrashReportUri = new Uri("");
        ...
        public static bool CheckForCommonErrors([CanBeNull] Exception ex)
        {
            ...
            try
            {
                ...
                {
                    message = "MyCraft could not locate Mono's compression functionality. " +
                ...
                {
                    message = "Something is incompatible with the current revision of MyCraft. " +
                ...
                {
                    message = "MyCraft was blocked from accessing a file or resource. " +
                              "Make sure that correct permissions are set for the MyCraft files, folders, and processes.";
                    return true;
                }
                else if (ex is OutOfMemoryException)
                {
                    message = "MyCraft ran out of memory. Make sure there is enough RAM to run.";
                    return true;
                }
                ...
                {
                    message = "Some Windows settings are preventing MyCraft from doing player name verification. " +
                              "See http://support.microsoft.com/kb/811833";
                    return true;
                }
                else if (ex.StackTrace.Contains("__Error.WinIOError"))
                {
                    message = "A filesystem-related error has occured. Make sure that only one instance of MyCraft is running, " +
