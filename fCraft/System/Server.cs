...
namespace fCraft
{
    ...
    public static partial class Server
    {
        ...
        /// <summary> This is where console registrate all the CMDs</summary>
        //public static Queue<String> LastCMD { get; set; }
        ...
        public static void InitLibrary([NotNull] IEnumerable<string> rawArgs)
        {
            ...
            {
                throw new InvalidOperationException("MyCraft library is already initialized");
            }
        ...
        public static void InitServer()
        {
            ...
            if (Updater.CurrentRelease.IsFlagged(ReleaseFlags.Dev))
            {
                Logger.Log(LogType.Warning,
                            "You are using an unreleased developer version of MyCraft. " +
                            "Do not use this version unless you are ready to deal with bugs and potential data loss. " +
                            "Consider using the lastest stable version instead, available from http://download.MyCraft-Public.tk");
            }
            ...
            {
                throw new Exception("MyCraft Config failed to initialize");
            }
        ...
        static void ShutdownNow([NotNull] ShutdownParams shutdownParams)
        {
            ...
            {
                Logger.LogAndReportCrash("Error in Server.Shutdown", "MyCraft", ex, true);
            }
#endif
        }
        ...
        public static void BackupData()
        {
            ...
            using (FileStream fs = File.Create(backupFileName))
            {
                try
                {
                    string fileComment = String.Format("Backup of MyCraft data for server \"{0}\", saved on {1}",
