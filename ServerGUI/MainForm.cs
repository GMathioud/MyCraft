...
namespace fCraft.ServerGUI
{
    ...
    public sealed partial class MainForm : Form
    {
        ...
        void StartUp(object sender, EventArgs a)
        {
            ...
            Text = "MyCraft " + Updater.CurrentRelease.VersionString + " - starting...";
            startupThread = new Thread(StartupThread);
            startupThread.Name = "MyCraft ServerGUI Startup";
            startupThread.Start();
        }
            ...
            try
            {
                ...
                if (updaterMode != UpdaterMode.Disabled)
                {
                    ...
                    if (Updater.UpdateCheck())
                    {
                        ...
                        {
                            String updateMsg = String.Format("A MyCraft update is available! Visit http://download.MyCraft-Public.tk to download. " +
        ...
        void OnInitSuccess()
        {
            Text = "MyCraft " + Updater.CurrentRelease.VersionString + " - " + ConfigKey.ServerName.GetString();
        }
        ...
        void Shutdown(ShutdownReason reason, bool quit)
        {
            ...
            Text = "MyCraft " + Updater.CurrentRelease.VersionString + " - shutting down...";
